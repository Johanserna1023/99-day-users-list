...
Esta es una solución del proyecto **Users List** como parte del reto de codificación #100DaysOfProjects [Front End Club](https://www.facebook.com/frontendclubfb). La mejor manera de escribir un buen código es programando todos los días🔥.
...
- [Pagina web](https://miguelramosalarcon.github.io/100DaysOfProjects/99-day-users-list/)
- [Codigo fuente]()
...
Usamos `javascript` para la funcionalidad del dropdown y buscador:
